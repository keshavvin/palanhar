    ...
    <section className="py-16 md:py-24 bg-gradient-to-b from-white to-cream-white/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-dark-green mb-4">हमारे गौ सेवा उत्पाद</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            गाय जो कुछ देती है, कृतज्ञता के साथ — शुद्ध A2 डेयरी, पंचगव्य
            और गौ-आधारित प्राकृतिक उत्पाद, तथा जैविक खेती की उपज
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            { id: 'panchgavya', label: 'पंचगव्य व गौ-आधारित' },
            { id: 'agriculture', label: 'जैविक कृषि' },
          ].map((btn) => (
            <motion.button
              key={btn.id}
        ...
        >
          <h3 className="text-3xl font-bold mb-4">ऑर्डर देने के लिए तैयार हैं?</h3>
          <p className="text-lg mb-6 opacity-90">
            ताज़े, जैविक उत्पाद सीधे आपके घर तक पहुँचाएँ। तेज़, भरोसेमंद डिलीवरी की गारंटी!
          </p>
          <Link
            to="/contact"
