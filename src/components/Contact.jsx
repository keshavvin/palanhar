...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: FaMapMarkerAlt,
      title: 'पता',
      value: 'मुख्य कार्यालय: C-773, JJVTS गार्डन, छतरपुर एक्स्टेंशन, नई दिल्ली – 110074 · ग्राम कार्यालय: आओग्राम, पूर्व बर्धमान, WB – 713121',
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-white to-cream-white/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-dark-green mb-4">संपर्क में रहें</h2>
          <p className="text-xl text-gray-600">कोई प्रश्न है? हमें आपसे सुनकर खुशी होगी!</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="mb-8">
              <h3 className="text-3xl font-bold text-dark-green mb-2">हमें संदेश भेजें</h3>
            ...
            {submitted ? (
              ...
              >
                ...
                <h4 className="text-2xl font-bold text-primary-green mb-2">धन्यवाद!</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.1 }}>
                  <label htmlFor="contact-name" className="block text-gray-700 font-semibold mb-3">पूरा नाम</label>
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.15 }}>
                  <label htmlFor="contact-email" className="block text-gray-700 font-semibold mb-3">ईमेल पता</label>
                  <div className="relative">
                    <input
                      id="contact-email"
                      type="email"
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.25 }}>
                  <label htmlFor="contact-message" className="block text-gray-700 font-semibold mb-3">संदेश</label>
                  <textarea
                    id="contact-message"
                    name="message"
                    ...
                    placeholder="अपनी बात हमें बताएँ..."
                    rows="5"
                    required
                  ></textarea>
                </motion.div>
          ...
          >
            ...
            <div className="card overflow-hidden shadow-lg h-80 bg-gradient-to-br from-light-green/20 to-primary-green/20 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-700 font-semibold">यहाँ गूगल मैप जोड़ा जाएगा</p>
              </div>
            </div>

            {/* Social Links */}
            <div className="card bg-white p-8">
              <h3 className="text-2xl font-bold text-dark-green mb-6">हमसे जुड़ें</h3>
              <p className="text-gray-600 mb-6">
                हमारे फार्म की नवीनतम जानकारी, सुझाव और कहानियों के लिए सोशल मीडिया पर हमसे जुड़ें.
              </p>
                ...
                {socialLinks.map((social, i) => {
                  ...
                  return (
                    <motion.a
                      key={i}
                      href={social.link}
                      aria-label={`${social.label} पर हमसे जुड़ें`}
            ...
            <div className="card bg-cream-white/80 p-8 border-l-4 border-primary-green">
              <h3 className="text-xl font-bold text-dark-green mb-4">कार्य समय</h3>
              <ul className="space-y-2 text-gray-700">
                <li><span className="font-semibold">सोमवार - शुक्रवार:</span> 8:00 AM - 6:00 PM</li>
                <li><span className="font-semibold">शनिवार:</span> 9:00 AM - 4:00 PM</li>
                <li><span className="font-semibold">रविवार:</span> 10:00 AM - 3:00 PM</li>
              </ul>
            </div>
          </motion.div>
        </div>
