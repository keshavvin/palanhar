...
export const investmentPlans = [
  {
    id: 'A',
    name: 'Option A — Gau Mitra',
    minAmount: 10_000,
    icon: '🌱',
    tagline: 'Begin your Gau Seva journey',
    highlights: [
      'Minimum investment ₹10,000',
      'Supports feed & care for our Gir cows',
  ...
  {
    id: 'B',
    name: 'Option B — Gau Palak',
    minAmount: 50_000,
    icon: '🐄',
    tagline: 'Nurture the gaushala as it grows',
    highlights: [
      'Minimum investment ₹50,000',
      'Supports cow care, shelter & veterinary needs',
      'Digital share certificate',
      'Annual dividend eligibility',
      'Priority support desk',
      'Quarterly gaushala reports',
    ],
    popular: true,
  },
  {
    id: 'C',
    name: 'Option C — Gau Rakshak',
    minAmount: 1_00_000,
    icon: '🏆',
    tagline: 'Become a guardian of the herd',
    highlights: [
      'Investment ₹1,00,000 and above',
      'Supports the full circle — cows, farm & panchgavya',
      'Digital share certificate',
      'Annual dividend eligibility',
      'Dedicated relationship manager',
      'Invitation to annual gaushala visit',
    ],
    popular: false,
  },
];
...
export const financialFlow = [
  ...
  { step: 2, icon: '💰', title: 'Invest in Gau Seva', desc: 'Choose a seva plan. Funds go directly to cow care, the gaushala and farm operations.' },
  ...
  { step: 4, icon: '🐄', title: 'Gaushala Creates Value', desc: 'A2 dairy, panchgavya products and organic produce create the company’s annual net profit.' },
  ...
  { step: 7, icon: '🏦', title: 'Withdraw or Reinvest', desc: 'Transfer to your verified bank account or reinvest to deepen your seva.' },
];
